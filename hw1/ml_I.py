...
def mean():
    ...
    print("The mean petal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pw_mean,virginica_pw_mean,versicolor_pw_mean))
    print("The mean petal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pl_mean, virginica_pl_mean, versicolor_pl_mean))
    print("The mean sepal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sw_mean, virginica_sw_mean, versicolor_sw_mean))
    print("The mean sepal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sl_mean, virginica_sl_mean, versicolor_sl_mean))
...
def max_min():
    ...
    print("The max petal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pw_max, virginica_pw_max, versicolor_pw_max))
    print("The min petal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pw_min, virginica_pw_min, versicolor_pw_min))

    print("The max petal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pl_max, virginica_pl_max, versicolor_pl_max))
    print("The min petal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_pl_min, virginica_pl_min, versicolor_pl_min))

    print("The max sepal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sw_max, virginica_sw_max, versicolor_sw_max))
    print("The min sepal width for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sw_min, virginica_sw_min, versicolor_sw_min))

    print("The max sepal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sl_max, virginica_sl_max, versicolor_sl_max))
    print("The min sepal length for setosa is %f , for virginica is %f , and for versicolor is %f " % (setosa_sl_min, virginica_sl_min, versicolor_sl_min))
